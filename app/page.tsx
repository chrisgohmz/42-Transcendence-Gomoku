    ...
    <main className="shell">
	  ...
	  <section className="panel">
        <article className="card">
          ...
          <p className="meta">
            View your personal statistics and edit your details. See your friends list, request or sent out. Message your friends.
          </p>
          <div className="inline-links">
            <Link className="text-link" href="/profile">Profile</Link>
            <Link className="text-link" href="/friends">Friends</Link>
            <Link className="text-link" href="/messages">Messages</Link>
          </div>
        </article>
      </section>
