    ...
    <main className="shell">
      <section className="mt-4 mb-12 flex flex-col items-center">
        <div className="mb-6 flex items-center gap-4">
          ...
          <h1 className="m-0 text-5xl font-bold">Messages</h1>
        </div>
            ...
            <div className="flex flex-1 flex-col gap-1 overflow-y-auto p-2">
              ...
              >
                ...
                <div className="flex-1 overflow-hidden text-left">
                  ...
                  <p className="m-0 truncate text-sm text-slate-400">GG well played.</p>
                </div>
              </button>
            </div>
          </div>
              ...
              <div className="flex max-w-[80%] flex-row-reverse gap-3 self-end">
                <div className="rounded-2xl rounded-br-sm bg-[#4ee8c2] p-3 text-[#04131a]">
                  <p className="m-0 font-medium">
                    Absolutely! Let me just finish setting up this profile page first.
                  </p>
                </div>
              </div>
            </div>
